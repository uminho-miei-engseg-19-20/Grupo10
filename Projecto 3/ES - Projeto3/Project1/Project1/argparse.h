...
class ArgumentParser {
 ...
 public:
  ...
  void print_help(size_t count = 0, size_t page = 0, std::string title = "") {
  ...
  void print_positional(size_t count = 0, size_t page = 0, std::string title = "") {
	  if (page * count > _arguments.size()) {
		  return;
	  }
	  if (page == 0) {
  ...
  void enable_help() {
    add_argument("-h", "--help", "show this help message and exit", false);
    _help_enabled = true;
  }
